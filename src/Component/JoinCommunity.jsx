          ...
          {socialLinks.map((social, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
              >
                <div className="flex items-center gap-5 p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl border-2 border-gray-200/50 dark:border-slate-700/50 hover:bg-white dark:hover:bg-slate-700/80 hover:border-blue-500/50 dark:hover:border-blue-400/50 transition-all duration-300 shadow-sm hover:shadow-xl h-full">
