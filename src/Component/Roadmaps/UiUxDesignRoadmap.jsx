...
import { uiUxDesignSteps } from "../../../data/uiUxDesignRoadmap";
...
const UiUxDesignRoadmap = () => {
  const [openStep, setOpenStep] = useState(null);
  const [completed, setCompleted] = useState([]);

  useEffect(() => {
    const storedCompleted = localStorage.getItem("completedUiUxDesignSteps");
    if (storedCompleted) {
  ...
  const toggleComplete = (index) => {
    ...
    localStorage.setItem("completedUiUxDesignSteps", JSON.stringify(newCompleted));
  };
...
export default UiUxDesignRoadmap;
