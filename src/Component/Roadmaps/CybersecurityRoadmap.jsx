...
import { cybersecuritySteps } from "../../../data/cybersecurityRoadmap";
...
const CybersecurityRoadmap = () => {
  ...
  useEffect(() => {
    const storedCompleted = localStorage.getItem("completedCybersecuritySteps");
    if (storedCompleted) {
  ...
  const toggleComplete = (index) => {
    ...
    localStorage.setItem("completedCybersecuritySteps", JSON.stringify(newCompleted));
  };
  ...
  return (
    <section className="mx-auto py-20 px-6 md:px-16 animate-fade-in dark:bg-gray-900 min-h-screen">
      ...
      <div className="space-y-6">
        {cybersecuritySteps.map((step, index) => (
          <div
            key={index}
