...
import { cloudComputingSteps } from "../../../data/cloudComputingRoadmap";
...
const CloudComputingRoadmap = () => {
  ...
  useEffect(() => {
    const storedCompleted = localStorage.getItem("completedCloudComputingSteps");
    if (storedCompleted) {
  ...
  const toggleComplete = (index) => {
    ...
    localStorage.setItem("completedCloudComputingSteps", JSON.stringify(newCompleted));
  };
  ...
  return (
    <section className="mx-auto py-20 px-6 md:px-16 animate-fade-in dark:bg-gray-900 min-h-screen">
      ...
      <div className="space-y-6">
        {cloudComputingSteps.map((step, index) => (
          <div
            key={index}
