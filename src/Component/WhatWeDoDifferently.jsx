  ...
  <section className="max-w-3xl mx-auto py-16 px-4 text-center animate-fade-in">
    ...
    <ul className="grid gap-4 md:grid-cols-3 text-left">
      <li className="bg-gray-100 rounded-lg p-6 shadow hover:shadow-lg transition group">
        <span className="text-2xl font-bold text-black group-hover:text-gray-700 transition">☕</span>
        <h3 className="font-semibold mt-2 mb-1 group-hover:text-grey transition">Cohorts</h3>
      ...
      <li className="bg-gray-100 rounded-lg p-6 shadow hover:shadow-lg transition group">
        <span className="text-2xl font-bold text-black group-hover:text-gray-700 transition">🛠️</span>
