      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-1 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="leading-tight">
              <motion.h1
                ...
                style={{
                  backgroundImage: "linear-gradient(135deg, #0d9dadff, #17c8c8ee, #0f7ec8ff, #8b5cf6, #ec4899)",
                }}
                whileHover={{ 
                  scale: 1.05,
                  backgroundImage: "linear-gradient(135deg, #ec4899, #8b5cf6, #0f7ec8ff, #17c8c8ee, #0d9dadff)",
                }}
                transition={{ 
                  type: "spring", 
                  stiffness: 300,
        ...
        >
          ...
          >
            ...
            >
                             <MoonStar className={`w-4 h-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`} />
            </motion.div>
          </motion.button>
        </motion.nav>
        ...
        {menuOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-2">
              ...
              <motion.div
                variants={mobileItemVariants}
                                 className={`pt-4 border-t ${isDarkMode ? 'border-gray-700/50' : 'border-gray-200/50'}`}
              >
                                 <button
