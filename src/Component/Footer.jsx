...
const Footer = () => {
  ...
  const FeedbackButton = () => (
    <div className="w-full flex justify-center py-6 bg-gradient-to-r from-blue-100 via-white to-blue-50 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800">
      <Link
        to="/feedback"
        className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
      >
        Give Feedback
      </Link>
    </div>
