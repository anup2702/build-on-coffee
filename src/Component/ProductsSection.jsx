  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Product cards in grid/flex-wrap */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-center mb-6">
                    <div
                      className={`p-4 rounded-2xl bg-gradient-to-br ${product.color}`}
                    >
                  ...
                  <div className="text-center">
                    <h3
                      className={`text-2xl font-bold text-gray-900 dark:text-white mb-4 transition-colors duration-200 ${product.hoverColor}`}
                    >
                      {product.name}
                    </h3>
