...
const testimonials = [
  {
    ...
    content: "BuildOnCoffee has been a game-changer for my learning journey. The curated resources and community support helped me land my dream job.",
    rating: 5
  },
  {
    id: 2,
    ...
    content: "The project ideas section gave me the perfect starting point for building my portfolio. Highly recommended for any developer!",
    rating: 5
  },
  {
    id: 3,
    ...
    content: "The roadmaps are incredibly well-structured. I went from beginner to intermediate in just 3 months following their learning paths.",
    rating: 5
  },
  {
    id: 4,
    ...
    content: "Free certificates from top platforms? Yes, please! This platform saved me thousands on learning resources.",
    rating: 5
  },
  {
    id: 5,
    ...
    content: "The community is amazing! I've connected with so many like-minded developers and learned from their experiences.",
    rating: 5
  },
  {
    id: 6,
    ...
    content: "The tools section introduced me to productivity tools I never knew existed. My development workflow has improved dramatically.",
    rating: 5
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-blue-50 dark:bg-blue-900/20 px-6 py-3 rounded-full mb-8 border border-blue-200 dark:border-blue-800">
            ...
            <span className="text-sm font-semibold text-blue-800 dark:text-blue-200">Community Voices</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto font-light leading-relaxed">
            Join thousands of developers who have transformed their careers with BuildOnCoffee.
          </p>
        </motion.div>
        ...
        <div className="relative overflow-hidden">
          ...
          {/* Scrolling Container */}
          <div className="flex gap-8 testimonials-scroll" style={{ width: 'max-content' }}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm">
            <div className="text-3xl font-black text-blue-600 dark:text-blue-400 mb-2">10K+</div>
            <div className="text-gray-600 dark:text-gray-300 font-medium">Happy Developers</div>
          </div>
          
          <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm">
            <div className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mb-2">4.9/5</div>
            <div className="text-gray-600 dark:text-gray-300 font-medium">Average Rating</div>
          </div>
          
          <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm">
            <div className="text-3xl font-black text-orange-600 dark:text-orange-400 mb-2">95%</div>
