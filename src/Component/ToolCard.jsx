  ...
  >
    ...
    {docs && (
      <div className="mb-2 w-full">
        <a href={docs} target="_blank" rel="noopener noreferrer" className="underline hover:text-black">Documentation</a>
      </div>
    )}
          ...
          {references.map((ref, i) => (
            ref.image ? (
              ...
              <div key={i} className="text-xs">
                <a href={ref.url} target="_blank" rel="noopener noreferrer" className="underline hover:text-black">{ref.label}</a>
              </div>
            )
          ))}
        </div>
    ...
    {link && (
      <a href={link} target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-white bg-black px-4 py-2 rounded hover:bg-gray-800 transition">Go to Course</a>
    )}
  </div>
);
