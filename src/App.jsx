      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <span className="text-sm font-medium text-blue-600">Our Products</span>
          </motion.div>
          ...
          >
            Discover powerful tools and resources designed to accelerate your development journey
          </motion.p>
        </motion.div>

        {/* Products Grid */}
        <motion.div 
          className="relative z-10 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-indigo-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                         ...
                         {/* Floating Elements */}
             <motion.div
               className="absolute top-4 right-4 w-8 h-8 bg-blue-100 rounded-full opacity-0 group-hover:opacity-100"
             />
            ...
            <div className="relative z-10">
               ...
               >
                <img src={courseimg} alt="Courses" className="w-full h-full object-contain" />
              </motion.div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Curated CS courses with video tutorials, comprehensive documentation, and reference materials.
              </p>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-emerald-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                         ...
                         {/* Floating Elements */}
             <motion.div
               className="absolute top-4 right-4 w-8 h-8 bg-green-100 rounded-full opacity-0 group-hover:opacity-100"
             />
            ...
            <div className="relative z-10">
                 ...
                 transition={{ duration: 0.6, ease: "easeInOut" }}
               >
                <img src={toolsimg} alt="Tools" className="w-full h-full object-contain" />
              </motion.div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Discover and use the best developer tools for enhanced productivity and workflow optimization.
              </p>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-pink-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                         ...
                         {/* Floating Elements */}
             <motion.div
               className="absolute top-4 right-4 w-8 h-8 bg-purple-100 rounded-full opacity-0 group-hover:opacity-100"
             />
            ...
            <div className="relative z-10">
                 ...
                 transition={{ duration: 0.6, ease: "easeInOut" }}
               >
                <img src={snapimg} alt="SnapFolio" className="w-full h-full object-contain" />
              </motion.div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Generate your developer portfolio instantly with our AI-powered portfolio builder. Try SnapFolio now!
              </p>
